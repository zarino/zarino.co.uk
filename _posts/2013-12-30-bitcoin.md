...
[{% img alt="Graph showing the median value of Bitcoin to US Dollar over 2013, starting at almost 1 USD, rising to a high of 1200 USD in early December, then ending the year at 800 USD" src="/media/bitcoin-usd-graph.png" srcset="/media/bitcoin-usd-graph.png 700w, /media/bitcoin-usd-graph@2x.png 1400w" %}](/media/bitcoin-usd-graph.png)
