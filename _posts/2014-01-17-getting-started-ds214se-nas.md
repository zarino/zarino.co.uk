...
{% img alt="Installing two 3.5-inch drives into the Synology DS214se" src="/media/synology-install-hardware.jpg" %}
...
{% img alt="Setting up your Synology DiskStation" src="/media/synology-setup-1.jpg" %}
...
{% img alt="Synology DiskStation installs itself" src="/media/synology-setup-2.jpg" %}
...
{% img alt="Synology DSM interface" src="/media/synology-dsm.jpg" %}
...
{% img alt="Synology Consistency Check" src="/media/synology-consistency-check.jpg" %}
